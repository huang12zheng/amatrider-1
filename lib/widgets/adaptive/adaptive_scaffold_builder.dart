...
class AdaptiveScaffoldBuilder extends StatelessWidget {
  ...
  final CupertinoTabBarData Function(BuildContext, PlatformTarget)? cupertinoTabs;
  final MaterialNavBarData Function(BuildContext, PlatformTarget)? materialTabs;
  final CupertinoTabScaffoldData Function(BuildContext, PlatformTarget)? cupertino;
  final MaterialTabScaffoldData Function(BuildContext, PlatformTarget)? material;
  final CupertinoTabScaffoldData Function(BuildContext, PlatformTarget, int)? cupertinoBuilder;
  final MaterialTabScaffoldData Function(BuildContext, PlatformTarget, int)? materialBuilder;
