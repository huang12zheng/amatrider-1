  ...
  Widget build(BuildContext context) {
    return AdaptiveScaffold(
      ...
      body: SafeArea(
        ...
        right: false,
        bottom: false,
        child: BlocSelector<ReviewsCubit, ReviewsState, Review>(
          selector: (s) => s.review,
          builder: (c, review) => DragToRefresh(
            initialRefresh: true,
            onRefresh: (controller) => onRefresh(c, controller),
            child: AnimatedVisibility(
              visible: review.feedbacks.isNotEmpty(),
              replacement: EmptyStateWidget(
                useScaffold: false,
                asset: right(AppAssets.noReviews),
                titleGap: 0.04.sw,
                                    ...
                                    children: [
                                      IgnorePointer(
                                        ...
                                        child: RatingBar(
                                          ...
                                          allowHalfRating: true,
                                          tapOnlyMode: true,
                                          initialRating: feedback?.rate.getOrNull?.toDouble() ?? 0.0,
                                          minRating: 1,
                                          maxRating: 5,
                                          itemSize: 0.05.sw,
                                          direction: Axis.horizontal,
