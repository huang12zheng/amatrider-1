...
const INCOMPLETE_OTP_CODE = 'Code must be greater than';
...
const INVALID_URL = 'Provide a valid URL!';
...
class FieldObjectException<T> with _$FieldObjectException<T> {
  ...
  factory FieldObjectException.exceedsLength({String? message}) => FieldObjectException(message: message ?? INVALID_FIELD_MESSAGE);
}
