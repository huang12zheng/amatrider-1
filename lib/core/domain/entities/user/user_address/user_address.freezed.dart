...
class _$_UserAddress extends _UserAddress {
  ...
  @override
  String toString() {
    return 'UserAddress(id: $id, lat: $lat, lng: $lng, zip: $zip, country: $country, alias: $alias, additionalInfo: $additionalInfo, apartment: $apartment, street: $street, address: $address, city: $city, landmark: $landmark, state: $state, entrance: $entrance, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
  }
...
abstract class _UserAddress extends UserAddress {
  const factory _UserAddress(
      ...
      DateTime? createdAt,
      DateTime? updatedAt,
      DateTime? deletedAt}) = _$_UserAddress;
