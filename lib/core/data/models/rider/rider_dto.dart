...
class RiderDTO with _$RiderDTO {
  ...
  const factory RiderDTO({
    ...
    @JsonKey(name: 'is_verified') @BooleanSerializer() bool? isVerified,
  ...
  Rider get domain => Rider(
        ...
        verificationStatus: verificationStatus != null ? verificationStatus! : ProfileVerificationStatus.fromBool(isVerified!),
        provider: provider!,
        createdAt: createdAt,
        updatedAt: updatedAt,
        deletedAt: deletedAt,
