...
/// A stateless widget to render StageOwnerWidget.
class StageOwnerWidget extends StatelessWidget with AutoRouteWrapper {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Align(
                  alignment:
                      centerAsset ? Alignment.center : Alignment.centerLeft,
                  child: asset.fold(
                    (_asset) => Image.asset(
                      _asset,
                      width: imageWidth,
